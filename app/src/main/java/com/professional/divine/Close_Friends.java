...
public class Close_Friends extends AppCompatActivity {
    ...
    com.professional.divine.DataBaseHelper dataBaseHelper = new com.professional.divine.DataBaseHelper(com.professional.divine.Close_Friends.this);
        ...
        if((requestCode==1) && (resultCode==RESULT_OK))
        {
            try{
                ...
                if(cursor != null && cursor.moveToNext())
                {
                    ...
                    Toast.makeText(com.professional.divine.Close_Friends.this,ToastMsg, Toast.LENGTH_SHORT).show();
                }
            }
            catch (Exception e)
            {
