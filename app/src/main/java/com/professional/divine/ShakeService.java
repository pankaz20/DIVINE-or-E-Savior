...
public class ShakeService extends Service implements ShakeListener.OnShakeListener {
    ...
    public void onCreate() {
        ...
        Toast.makeText(com.professional.divine.ShakeService.this, "Service is created!",Toast.LENGTH_LONG).show();
    ...
    public void onShake() {
        if(check==1) {
            Toast.makeText(com.professional.divine.ShakeService.this, "SHAKEN!", Toast.LENGTH_LONG).show();
