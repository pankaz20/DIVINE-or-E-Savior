    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btPicker.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                try {
                    startActivityForResult(builder.build(com.professional.divine.HomeLocation.this),
...
//                stringBuilder.append(longitude);
    ...
    private void showMessageOKCancel(String message) {
        new android.app.AlertDialog.Builder(com.professional.divine.HomeLocation.this)
                .setMessage(message)
